namespace Loupedeck.GimpPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.GimpPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.GimpPlugin.Resources.Resource.txt`.
